...
if ( ! class_exists( 'Hamilton_Customize' ) ) :
	 ...
	 *
	 * This class handles the customization options for the Hamilton theme.
	 */
	class Hamilton_Customize {

		/**
		 * Registers customization settings and controls for the Hamilton theme.
		 *
		...
		public static function live_preview() {
			wp_enqueue_script(
				...
				wp_get_theme( 'hamilton' )->get( 'Version' ),
				true
			);
		}
	}
